...
# datasets related
from lib.train.dataset import Lasot, Got10k, MSCOCOSeq, ImagenetVID, TrackingNet, LasHeR_trainingSet,RGBT234,LasHeR_testingSet,LasHeR_trainingSet_lmdb,RGBT234_lmdb,VTUAV
...
from lib.train.run_training import worker_init_fn
...
def names2datasets(name_list: list, settings, image_loader, attr=None):
    ...
    for name in name_list:
        #print('name',name)
        assert name in ['LasHeR_testingSet','RGBT234',"LasHeR_trainingSet",'LasHeR',"LASOT", "GOT10K_vottrain", "GOT10K_votval", "GOT10K_train_full", 
                        "COCO17", "VID", "TRACKINGNET", "vtuav", "VTUAV", "VTUAV_test_SL"]
        ...
        if name == "LasHeR_testingSet":
            datasets.append(LasHeR_testingSet(settings.env.lasher_testingset_dir, split='train', image_loader=image_loader, attr=attr))
